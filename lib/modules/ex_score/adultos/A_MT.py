...
def score(data):
    score=True
    ## Calification rules
    max_border_1 = 160          # Max threshold for valid point
    min_border_1 = 0            # Min threshold for valid point

    max_border_2 = 160          # Max threshold for valid point
    min_border_2 = 0            # Min threshold for valid point

    max_threshold_1 = 80        # Threshold for valid peak
    min_ang = 70                # Threshold for great peak
    ...
    df.loc[df['max_2'] <= max_threshold_1, 'max_2'] = np.nan
    ...
    if (n_rep>=n_exp_rep):
        ...
        rec = 'Asegúrate de tocar el talón con tu mano'
        if(rec not in rep_rec):
        ...
        rec = 'Asegúrate de tocar el talón con tu mano ¡Tú puedes!'
        if(rec not in rep_rec):
            angle_rec.append(rec)
