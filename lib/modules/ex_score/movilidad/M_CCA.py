...
def score(data):
    ...
    max_border = 400         # Max threshold for valid point
    min_border = -400        # Min threshold for valid point

    base_ang = 0            # Objective angle
    threshold_ang = 5       # Threshold for valid peak
    max_ang = 40            # Threshold for great peak

    n_exp_rep = 12          # Expected repetitions
    n_min_rep = 8          # Minimum reps
